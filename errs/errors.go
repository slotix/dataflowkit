...
type ParserErrCode uint32
const (
	ErrNoParts ParserErrCode = iota
	ErrNoSelectors
	ErrEmptyResults
	ErrNoCommonAncestor
)
...
func (e *BadPayload) Error() string {
	switch e.ParserErrCode{
	case ErrNoParts:
		return "no parts found"
	case ErrNoSelectors:
		return "no selectors found"
	case ErrEmptyResults:
		return "empty results"
	case ErrNoCommonAncestor:
		return "no common ancestor for selectors found"
	}
	return "unknown"
}
