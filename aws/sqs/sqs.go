...
const (
	QueueUrl    = "https://sqs.us-east-1.amazonaws.com/060679207441/fetch.fifo"
	AWSRegion   = "us-east-1"
	MaxRetries  = 5
)

func NewSvc(Region string, MaxRetries int) *sqs.SQS {
...
func ReceiveMessage(svc *sqs.SQS, queueUrl string, maxNumberOfMessages, visibilityTimeout, waitTimeSeconds int64) (*sqs.ReceiveMessageOutput, error) {
	params := &sqs.ReceiveMessageInput{
		...
		AttributeNames:      aws.StringSlice([]string{"All" /*"MessageGroupId"*/}),
	}
